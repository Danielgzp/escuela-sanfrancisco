  ...
  var dzMorris = (function () {
    ...
    var donutChart = function () {
      Morris.Donut({
        ...
        resize: true,
        redraw: true,
        colors: [" #143b64", "rgb(255, 184, 0)", "#2bc155"],
        //responsive:true,
      });
    };
    ...
    var lineChart2 = function () {
      ...
      Morris.Area({
        ...
        pointSize: 3,
        fillOpacity: 0,
        pointStrokeColors: ["#f35757", "#2bc155", " #143b64"],
        behaveLikeLine: true,
        gridLineColor: "transparent",
        lineWidth: 3,
        hideHover: "auto",
        lineColors: ["rgb(243, 87, 87)", "rgb(0, 171, 197)", " #143b64"],
        resize: true,
      });
    };
    ...
    var barChart = function () {
      ...
      Morris.Bar({
        ...
        ykeys: ["a", "b", "c"],
        labels: ["A", "B", "C"],
        barColors: [" #143b64", "#2bc155", "#ff9f00"],
        hideHover: "auto",
        gridLineColor: "transparent",
        resize: true,
        barSizeRatio: 0.25,
    ...
    var areaChart = function () {
      ...
      Morris.Area({
        ...
        lineColors: [" #143b64", "rgb(16, 202, 147)", "rgb(255, 184, 0)"],
        xkey: "period",
        ykeys: ["smartphone", "windows", "mac"],
        labels: ["Phone", "Windows", "Mac"],
        pointSize: 0,
