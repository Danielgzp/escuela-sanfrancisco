!(function (t, e, s, i) {
  ...
  var n = "ontouchstart" in s,
    ...
    a = {
      ...
      emptyClass: "dd-empty",
      expandBtnHTML:
        '<button className="dd-expand" data-action="expand" type="button">Expand</button>',
      collapseBtnHTML:
        '<button className="dd-collapse" data-action="collapse" type="button">Collapse</button>',
      group: 0,
      maxDepth: 5,
      threshold: 20,
      fixedDepth: !1,
      ...
      listRenderer: function (t, e) {
        var s = "<" + e.listNodeName + ' className="' + e.listClass + '">';
      ...
      itemRenderer: function (e, s, i, o, n) {
        var l = t
          ...
          a = "<" + o.itemNodeName + l + ">";
        return (
          (a += "<" + o.handleNodeName + ' className="' + o.handleClass + '">'),
          (a +=
            "<" + o.contentNodeName + ' className="' + o.contentClass + '">'),
          (a += s),
          (a += "</" + o.contentNodeName + ">"),
          (a += "</" + o.handleNodeName + ">"),
          (a += i),
  ...
  (o.prototype = {
    init: function () {
      ...
      s.reset(),
        ...
        (s.placeEl = t('<div className="' + s.options.placeClass + '"/>'));
    ...
    appendEmptyElement: function (t) {
      t.append('<div className="' + this.options.emptyClass + '"/>');
    },
  }),
