...
!(function () {
  ...
  function s(s, r) {
    ...
    if (
    ...
    ) {
      {
        var S = [
          ...
          '<button type="button" className="btn btn-sm btn-default clockpicker-button clockpicker-am-button">',
          "AM</button>",
          '<button type="button" className="btn btn-sm btn-default clockpicker-button clockpicker-pm-button">',
          "PM</button>",
          "</div>",
        ].join("");
        n(S);
      ...
      n(
        '<button type="button" className="btn btn-sm btn-default clockpicker-button am-button">AM</button>'
      )
        .on("click", function () {
        ...
        n(
          '<button type="button" className="btn btn-sm btn-default clockpicker-button pm-button">PM</button>'
        )
          .on("click", function () {
            (x.amOrPm = "PM"),
    ...
    r.autoclose ||
      n(
        '<button type="button" className="btn btn-sm btn-default btn-block clockpicker-button">' +
          r.donetext +
          "</button>"
      )
    ...
    var E,
      ...
      I,
      B,
      z = n('<div className="clockpicker-tick"></div>');
    if (r.twelvehour)
      for (E = 1; 13 > E; E += 1)
        (D = z.clone()),
          (I = (E / 6) * Math.PI),
  ...
  var c,
    ...
    V = [
      ...
      "</div>",
      '<span className="clockpicker-am-pm-block">',
      "</span>",
      "</div>",
      "</div>",
    ].join("");
