...
!(function (t, e) {
  ...
  var r = a(t),
    ...
    f = {
      init: function (t) {
        var e = '<input type="text" className="' + t.namespace + '-hex" />';
    ...
    m = {
      defaults: {
        template: function (t) {
          return '<div className="' + t + '-saturation"><i><b></b></i></div>';
        },
      },
      width: 0,
      height: 0,
    ...
    g = {
      defaults: {
        ...
        cancelText: null,
        template: function (t) {
          return '<div className="' + t + '-buttons"></div>';
        },
    ...
    y = {
      defaults: {
        template: function (t) {
          return '<div className="' + t + '-trigger"><span></span></div>';
        },
      },
      init: function (t, e) {
        (this.options = $.extend(this.defaults, e)),
    ...
    w = {
      defaults: {
        template: function (t) {
          return '<a href="#" className="' + t + '-clear"></a>';
        },
      },
      init: function (t, e) {
        t.options.hideInput ||
  ...
  var b = {
      defaults: {
        template: function (t) {
          return '<ul className="' + t + '-palettes"></ul>';
        },
        item: function (t, e) {
          return (
            '<li data-color="' +
  ...
  var M = {
      defaults: {
        ...
        template: function () {
          var t = this.api.namespace,
            e = '<div className="' + t + '-gradient-control">';
          return (
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.$dropdown = (0, r.default)(
                  ...
                  this.$element
                    .wrap('<div className="' + this.classes.wrap + '"></div>')
