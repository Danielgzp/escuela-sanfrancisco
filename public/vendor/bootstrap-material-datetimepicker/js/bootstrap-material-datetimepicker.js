  ...
  Plugin.prototype = {
    ...
    initTemplate: function () {
      ...
      for (var i = y - 3; i < y + 4; i++) {
        yearPicker +=
          '<div className="year-picker-item" data-year="' +
          i +
          '">' +
          i +
          "</div>";
      ...
      var yearHtml =
        ...
        '<div><a href="#!" className="btn btn-default dtp-select-year-range before" style="margin: 0;"><i className="material-icons">keyboard_arrow_up</i></a></div>' +
        yearPicker +
        '<div><a href="#!" className="btn btn-default dtp-select-year-range after" style="margin: 0;"><i className="material-icons">keyboard_arrow_down</i></a></div>' +
        "</div>";
      ...
      this.template =
        ...
        '<div className="dtp-close"><a href="#!"><i className="material-icons">clear</i></a></div>' +
        "</header>" +
        '<div className="dtp-date hidden">' +
        "<div>" +
        '<div className="left center p10">' +
        '<a href="#!" className="dtp-select-month-before"><i className="material-icons">chevron_left</i></a>' +
        "</div>" +
        '<div className="dtp-actual-month p80">MAR</div>' +
        '<div className="right center p10">' +
        '<a href="#!" className="dtp-select-month-after"><i className="material-icons">chevron_right</i></a>' +
        "</div>" +
        ...
        "<div>" +
        '<div className="left center p10">' +
        '<a href="#!" className="dtp-select-year-before"><i className="material-icons">chevron_left</i></a>' +
        "</div>" +
        '<div className="dtp-actual-year p80' +
        (this.params.year ? "" : " disabled") +
        '">2014</div>' +
        '<div className="right center p10">' +
        '<a href="#!" className="dtp-select-year-after"><i className="material-icons">chevron_right</i></a>' +
        "</div>" +
        '<div className="clearfix"></div>' +
        "</div>" +
        "</div>" +
        ...
        '<a className="dtp-meridien-am" href="#!">AM</a>' +
        "</div>" +
        '<div className="dtp-actual-time p60"></div>' +
        '<div className="right p20">' +
        '<a className="dtp-meridien-pm" href="#!">PM</a>' +
        "</div>" +
        '<div className="clearfix"></div>' +
        "</div>" +
        ...
        if (calendar.days[i] != 0) {
          if (
            ...
            if (
              ...
              _template +=
                '<a href="#!" className="dtp-select-day selected">' +
                moment(calendar.days[i]).locale(this.params.lang).format("DD") +
                "</a>";
            } else {
              _template +=
                '<a href="#!" className="dtp-select-day">' +
                moment(calendar.days[i]).locale(this.params.lang).format("DD") +
                "</a>";
            }
          }
